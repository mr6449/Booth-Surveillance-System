      ...
      <div class="wrapper">
         ...
         <header class="main-header">
            ...
            <div class="seipkon-logo">
               <a href="index">
               <img src="<%=request.getContextPath() %>/adminResources/image/download.png" alt="logo" style="width:200px;height:65px">
               </a>
            </div>
            <!-- Logo End -->
                     ...
                     <div class="col-md-12">
                        <div class="page-box">
                           <div class="datatables-example-heading">
                              <h3 align="center">Complaint Details</h3>
                           </div>
                           
                           <div class="advance-table">
                           <div id="responsive_datatables_example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer"><div class="row"><div class="col-sm-6"><div class="dataTables_length" id="responsive_datatables_example_length"><label>Show <select name="responsive_datatables_example_length" aria-controls="responsive_datatables_example" class="form-control input-sm"><option value="10">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option></select> entries</label></div></div><div class="col-sm-6"><div id="responsive_datatables_example_filter" class="dataTables_filter"><label><input type="search" class="form-control input-sm" placeholder="Search..." aria-controls="responsive_datatables_example"></label></div></div></div><div class="row"><div class="col-sm-12">
