                     ...
                     <div class="col-md-12">
                        <div class="page-box">
                           <div class="form-example">
                              <h3 align="center">Allocate Staff</h3>
                      ...
                      <label class="control-label">Booth No:</label>
                       Booth No: <f:select path="BoothVO.boothId" class="form-control">
                        ...
                        <f:select path="StaffVO.staffId" class="form-control">
                                                                     <option>Select</option>
