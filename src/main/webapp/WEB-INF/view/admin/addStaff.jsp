                  ...
                  <div class="row">
					...
					<div class="row">
                                       <div class="col-md-12">
                                             ...
                                             <label class="control-label">Photo:</label>
                                              <input type="file" name="file" placeholder="Photo" class="form-control" oncl required>
					...
					<div class="row">
                                       <div class="col-md-12">
                                             ...
                                             <f:input path="cityName"  placeholder="City Name" class="form-control" required="required"/>
					...
					<div class="row">
                                       <div class="col-md-12">
                                             ...
                                             <f:input path="areaName"  placeholder="Area Name" class="form-control" required="required"/>
