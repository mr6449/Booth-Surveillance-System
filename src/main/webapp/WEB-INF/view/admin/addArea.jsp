               ...
               <div class="container-fluid">
                  ...
                  <div class="row">
					...
					<div class="col-md-12">
                     ...
                     <f:input type="text" placeholder="Area Name" class="form-control" path="areaName" required="required" />
					...
					<div class="col-md-12">
                     ...
                     <label class="control-label">Area Description:</label>
                      <f:textarea placeholder="Area Description"  path = "areaDescription" class="form-control" required="required" ></f:textarea>
