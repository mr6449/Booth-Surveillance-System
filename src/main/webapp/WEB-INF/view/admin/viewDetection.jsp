...
function fn1()
	...
	//htp.open("get","https:///thesavirat.serveo.net/?imageName="+inputNode,true);
...
//htp.open("get","https:///thesavirat.serveo.net/peoplecounter",true);
                              ...
                              <div class="col-md-6 col-sm-6">
                                 <div class="seipkon-breadcromb-right">
                                    <ul>
                                       <li><a href="/">home</a></li>
                                       <li>Detection</li>
                                       <li>View Detection & LineCross</li>
                                    </ul>
                                 </div>
                              </div>
                           </div>
                     ...
                     <div class="col-md-12">
                        <div class="page-box">
                           <div class="form-example">
                              <h3 align="center">View Detection & LineCross</h3>
